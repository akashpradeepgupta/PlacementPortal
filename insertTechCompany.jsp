...
<html lang="en">
	...
	<form method="post" action="TechCompanyServlet">
		<input type ="text" placeholder="COMPANY NAME" name="cname" required><br/><br>
		<input type ="text" placeholder="CIN" name="cIN" required><br><br>
		<input type ="text" placeholder="EMAIL ID" name="cEmailID" required><br><br>
		<input type ="text" placeholder="CPI" name="cpiCriteria" required><br><br>
		<input type ="text" placeholder="COMPANY CENTER" name="city" required><br><br>
		<input type ="text" placeholder="VISITING DATE" name="visitDate" required><br><br>
		...
		<input type ="text" placeholder="REQUIREMENTS" name="requirements" required><br><br>		
