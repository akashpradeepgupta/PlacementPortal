...
<html lang="en">
	<head>
		...
		<title>PLACED STUDENT STATUS</title>
	...
	<body data-spy="scroll" data-target=".main-nav">
		...
		<section class="home" id="home" data-stellar-background-ratio="0.4">
			<div>
			<div class="container">
				<div class="row,col-md-12,st-home-unit,hero-txt"><br><br><br><br>
					<!--<div class="col-md-12">
...
<h2 style="color: white">ENTER THE COMPANY NAME</h2>
<br>
<form method="post" action="placedStudentServlet">
<input type ="text" placeholder="COMPANY NAME" name="cname" REQUIRED><br><br><br>
<input type="submit" class="btn btn-main btn-lg" value="Submit"><br><br><br><br>
</form>
</div>
</div>
