...
<input type="text" placeholder="USER ID" name="userID" class="q" required input pattern=".{5,}" required title="Minimum 5 characters" >
<br><br>
<input type="password" placeholder="OLD PASSWORD" name="opass" class="w" input pattern=".{5,}" required title="Minimum 5 characters" required>
<br><br>
<input type="password" placeholder="NEW PASSWORD" name="npass" class="e"  input pattern=".{5,}" required title="Minimum 5 characters" required>
<br><br>
<input type="password" placeholder="CONFIRM PASSWORD" name="cpass" class="r" input pattern=".{5,}" required title="Minimum 5 characters" required>
<br><br>
