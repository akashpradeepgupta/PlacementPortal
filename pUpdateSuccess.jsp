            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <h2 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">Password Updated<span> Succesfully</span></h2>
                        <center>
                        <a data-scroll href="form.jsp" class="btn btn-default wow fadeInUp" data-wow-offset="50" data-wow-delay="0.6s">BACK TO LOGIN</a>
                        </center>
                    </div>
                </div>
            </div>
