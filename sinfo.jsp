...
<html lang="en">
	<head>
		...
		<title>STUDENT SELECTION CATEGORY</title>
...
<tr>
<th align="center"><form action="changePassword.jsp">
    <input type="submit" value="CHANGE EXISTING PASSWORD" class="btn btn-main btn-lg a" />
</form></th>
<th align="center"><form action="CompanyVisit.jsp">
	<input type="submit" value="COMPANY VISITING" class="a btn btn-main btn-lg" />
</form></th>
<th align="center"><form method="post" action="selectionServlet">
	<input type="submit" value="ELIGIBLE FOR COMPANIES" class="a btn btn-main btn-lg" />
</form></th></tr>
</table><br><br><br>
<div>
	<table width="100%" class="container col-sm-6">
<tr align="center">
		<form action="logout.jsp">
	<input type="submit" value="LOGOUT" class="a btn btn-main btn-lg" />
</form>
	</tr>
</table>
</div>
