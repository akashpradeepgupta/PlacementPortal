            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <h2 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">Companies You are <span>Eligible For:-</span></h2>
                 		<center><h3 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s"><%
Company q[]=(Company[])session.getAttribute("q");
int count=1;
for(int i=0;i<10;i++){
	try{
...
if(count==1){
	out.println("your credentials don't satisfy the placement criteria for any company "+"<br>"+"<b>");
}
%>
</h3>
<a data-scroll href="form.jsp" class="btn btn-default wow fadeInUp" data-wow-offset="50" data-wow-delay="0.6s">BACK TO LOGIN</a></center>
	 </div>
                </div>
            </div>
        </section>
