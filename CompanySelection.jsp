...
<html lang="en">
	<head>
		...
		<title>ELIGIBILTY CRITERIA</title>
...
<h2 style="color: white">CHECK STUDENT IS SATISFYING THE COMPANY's CRITERIA FOR SELECTION</h2><br><br>
<input type="text" placeholder="COMPANY NAME" name="name" required><br><br><br>
