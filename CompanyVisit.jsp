...
<h2 style="color: white">CHECK VISITING COMPANIES</h2><br><br>
<input type="text" placeholder="Enter the Start Date(YYYY-MM-DD)" name="sdate" required>
<br><br>
<input type="text" placeholder="Enter the End Date(YYYY-MM-DD)" name="edate" required>
<br><br><br>
