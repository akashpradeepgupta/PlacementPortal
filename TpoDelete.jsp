...
<html lang="en">
	<head>
		...
		<title>DELETE STUDENT/CELL_MEMBER</title>
						...
						<div class="st-home-unit">
							<div class="hero-txt">
								...
								<div class="s" align="center">
									<h2 style="color: white">DELETE STUDENT/CELL MEMBER</h2><br><br>
<form method="post" action="deleteServlet">
<input type ="text" placeholder="User ID" name="rollno" required input pattern=".{5,}" required title="Minimum 5 characters">
<br/><br/>
<h5 style="color: white">Designation</h5><select name="Designation">
	<option>student</option>
	<option>cell_members</option>
</select>
<br/><br/><br>
<input type="submit" value="Submit" class="a btn btn-main btn-lg">
</form>
</div>							</div>
