...
<h2 style="color: white"> EDIT DETAILS </h1>
<form method="get" action="tpoServlet">

	<input type ="text" placeholder="USER ID" name="rollno" class="q" required input pattern=".{5,}" required title="Minimum 5 characters">
	<br/><br/>
	<h5 style="color: white">Select What You Want to Edit<h5><select name="edit" class="w">
		<option>sname</option>
